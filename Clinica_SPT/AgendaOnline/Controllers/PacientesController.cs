...
namespace AgendaOnline.Controllers
{
    public class PacientesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PacienteId,NomePaciente,Email,Telefone1,Celular,Observacao")] Paciente paciente)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PacienteId,NomePaciente,Email,Telefone1,Celular,Observacao")] Paciente paciente)
        {
